...
//            $anchor
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        if(null === $subscription){
            $array = [
                'code' => 'error',
                'message' => $translator->trans('app.subscription.subscription.delete.deleteErrorMissingText')
            ];
        ...
        $array = [
            'code' => 'success',
            'message' => $translator->trans('app.subscription.subscription.edit.saveSucessText')
        ];
