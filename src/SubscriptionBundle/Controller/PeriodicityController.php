...
class PeriodicityController extends Controller
{
    ...
    {
        $periodicityManager = $this->get('subscription.manager.periodicity');
        $formHandler = $this->get('subscription.form.handler.periodicity');
        ...
        if($formHandler->process($request)){
            ...
            if($periodicityManager->save($periodicity)){
                ...
                $this->addFlash('success', $translator->trans('subscription.periodicity.edit.saveSucessText'));
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        if(null === $periodicity){
            $array = [
                'code' => 'error',
                'message' => $translator->trans('subscription.periodicity.delete.deleteErrorMissingText')
            ];
        ...
        $array = [
            'code' => 'success',
            'message' => $translator->trans('subscription.periodicity.delete.deleteSuccessText')
        ];
